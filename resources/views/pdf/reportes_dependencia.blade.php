...
>
	<div class="card-header row {{ 
		...
		<h3 class="col-10">{{$incidente->catalogo_incidente ? $incidente->catalogo_incidente->clave." ".$incidente->catalogo_incidente->nombre : "N/A"}} / Reportes de las dependencias</h3>
