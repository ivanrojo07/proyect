...
{{-- Titulo de sidebar --}}
@section('titulopanel')
        <h5 style="color: black;">Administración de instituciones 
        </h5>
@endsection
...
@section('modal')
  <!-- The Modal -->
  <div class="modal" id="searchInstitucion">
    <div class="modal-dialog">
      <div class="modal-content">
      
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title text-dark">Buscar Institucion</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        {{-- formulario search --}}
        <form action="{{ route('admin.institucion.index') }}" method="GET">
