...
class TlaxcalaLocalidadSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($query_rows as $element) {
    		$id_anterior+=1;
    		$municipio = Municipio::where('nombre',$element->nombre_mun)->where('estado_id',$tlaxcala->id)->first();
    		$tlaxcala_localidad = new Localidad([
    			'id' => $id_anterior,
    		...
    		$tlaxcala_localidad->save();
    		var_dump($tlaxcala_localidad);
    	}
    }
}
