...
class PueblaLocalidadSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($query_rows as $element) {
        	$id_anterior += 1;
        	$municipio = Municipio::where('nombre',$element->nombre_mun)->where('estado_id',$puebla->id)->first();
        	$puebla_localidad = new Localidad([
        		'id' => $id_anterior,
        	...
        	$puebla_localidad->save();
        	var_dump($puebla_localidad);
        }
    }
}
