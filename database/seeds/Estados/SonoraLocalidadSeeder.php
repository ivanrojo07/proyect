...
class SonoraLocalidadSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($query_rows as $element) {
        	$id_anterior += 1;
        	$municipio = Municipio::where('nombre',$element->nombre_mun)->where('estado_id',$sonora->id)->first();
        	$sonora_localidad = new Localidad([
        		'id' => $id_anterior,
        	...
        	$sonora_localidad->save();
        	var_dump($sonora_localidad);
        }
    }
}
